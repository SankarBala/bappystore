                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        ...
                                        @if($seller->user->banned != 1)
                                          ...
                                          <a href="#" class="dropdown-item" onclick="show_recharge_modal('{{$seller->user->id}}')">  
...
<div class="modal fade" id="recharge_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="" action="{{ route('seller.recharge-wallet') }}" method="post">
